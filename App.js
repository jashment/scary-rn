    ...
    <SafeAreaProvider style={styles.container}>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Tome of Terror" screenOptions={{gestureEnabled: true}}>
          <Stack.Screen name="Tome of Terror" component={Home} options={{ headerTransparent: true, headerTitleAlign: 'center', headerStyle: {height: 75}, headerTitleStyle: {color: 'white'}}} />
